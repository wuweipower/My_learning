...
/*!
 * \brief Represents a complete data dataset
...
std::vector<std::vector<Pixel>> read_test_images() {
    return read_mnist_image_file<Pixel>("data/t10k-images-idx3-ubyte");
}
...
std::vector<Label> read_training_labels() {
    return read_mnist_label_file<Label>("data/train-labels-idx1-ubyte");
}
...
std::vector<Label> read_test_labels() {
    return read_mnist_label_file<Label>("data/t10k-labels-idx1-ubyte");
}
